...
import { getUserEmail, getUserFullName } from "@/shared/api/user";
...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 flex h-11 w-11 items-center justify-center rounded-full bg-brand-500 text-white font-semibold text-md">
          {getInitials(getUserFullName())}
        </span>

        <span className="block mr-1 font-medium text-theme-sm">{getUserFullName()}</span>
        <svg
